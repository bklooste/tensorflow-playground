...
export class AppendingLineChart {
  ...
  private paths: Array<d3.Selection<d3.BaseType, {}, HTMLElement, any>>;
  private lineColors: string[];

  private minY = Number.MAX_VALUE;
  private maxY = Number.MIN_VALUE;

  constructor(container:  d3.Selection<d3.BaseType, {}, HTMLElement, any> , lineColors: string[]) {
    this.lineColors = lineColors;
    this.numLines = lineColors.length;
    const node = container.node() as any as HTMLElement;
